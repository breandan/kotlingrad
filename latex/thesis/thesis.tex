...
\end{pclisting}
%
To refer to the container, we can either use \inline{18f13bb4571a} or the designated name (i.e. \inline{shady\_giraffe}). This image repository will be called \inline{user/duck}, and has an optional version identifier, \inline{:v2}, which can be pushed to the \href{http://hub.docker.com}{Docker Hub} registry:
...
\begin{pclisting}
~$ docker run user/duck:v6 (*\hl{-v HOST_PATH:TARGET_PATH}*)
\end{pclisting}
%

...
\addplot table [mark=none, x=x, y=y] {../data/poly_train_loss.csv};
\addplot [name path=upper,draw=none] table[x=x, y=y, err=err, y expr=\thisrow{y}+\thisrow{err}] {../data/poly_train_loss.csv};
\addplot [name path=lower,draw=none] table[x=x, y=y, err=err, y expr=\thisrow{y}-\thisrow{err}] {../data/poly_train_loss.csv};
...
\addplot+[blue] table [mark=none, x=x, y=y1] {../data/seff.csv};
\addlegendentry{Probabilistic Generator}
\addplot [name path=upper1,draw=none] table[x=x, y1=y1, y1_err=y1_err, y expr=\thisrow{y1}+\thisrow{y1_err}] {../data/seff.csv};
\addplot [name path=lower1,draw=none] table[x=x, y1=y1, y1_err=y1_err, y expr=\thisrow{y1}-\thisrow{y1_err}] {../data/seff.csv};
\addplot [fill=blue!10] fill between[of=upper1 and lower1];
\addplot+[red] table [mark=none, x=x, y=y2] {../data/seff.csv};
\addlegendentry{Differential Adversary}
\addplot [name path=upper2,draw=none] table[x=x, y2=y2, y2_err=y2_err, y expr=\thisrow{y2}+\thisrow{y2_err}] {../data/seff.csv};
\addplot [name path=lower2,draw=none] table[x=x, y2=y2, y2_err=y2_err, y expr=\thisrow{y2}-\thisrow{y2_err}] {../data/seff.csv};

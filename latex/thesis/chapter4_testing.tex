...
\centering
\begin{tikzpicture}
\begin{axis}[title={Average loss over time}, width=\textwidth, height=10cm, xlabel=Epoch, ylabel=Normalized MSE, legend pos=north east, align=center]
...
\end{axis}
\end{tikzpicture}
\caption{Normalized losses from 160 trajectories of momentum SGD in parameter space.}
...
In this chapter we have visited some interesting ideas for validating intelligent systems from the perspective of software engineering and machine learning. We have seen a curious resemblance between some new and old ideas in adversarial learning and fuzz testing. We have proposed a framework for evaluating differentiable programs in a low-cost, data-driven manner and suggest some intriguing directions for future research. This work was partly inspired by \citet{lample2019deep}, in particular the expression tree generator from ~\autoref{sec:prob_ad_test}.
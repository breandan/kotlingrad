...
\begin{document}
    ...
    \begin{frame}
        ...
        %
        \begin{align*}
            \mathbf{\hat P}_k(\mathbf{x}; \mathbf{\boldsymbol\Theta}) = \begin{cases} \mathbf{p}_0(\mathbf{x}; \boldsymbol\theta_0) &\text{if } k=0\\ \big(\mathbf{p}_k(\boldsymbol\theta_k)\circ \mathbf{\hat P}_{k-1}(\boldsymbol\Theta_{<k})\big)\big(\mathbf{x}\big)&\text{if } k > 0 \end{cases} \\
        \end{align*}
        %

...
\centering
\begin{tikzpicture}
\begin{axis}[title={Average training loss over time}, width=\textwidth, height=10cm, xlabel=Epoch, ylabel=Mean Squared Error, legend pos=north east, align=center,
yticklabel style={
...
\addplot+[smooth] table [mark=none, x=x, y=y] {../data/poly_train_loss.csv};
\addplot [smooth, name path=upper,draw=none] table[x=x, y=y, err=err, y expr=\thisrow{y}+\thisrow{err}] {../data/poly_train_loss.csv};
\addplot [smooth, name path=lower,draw=none] table[x=x, y=y, err=err, y expr=\thisrow{y}-\thisrow{err}] {../data/poly_train_loss.csv};

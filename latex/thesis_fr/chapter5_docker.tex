...
\subsection{Création d'un instantané d'image}\label{subsec:creating-an-image-snapshot}
...
\begin{pclisting}
~$ echo "(*@\hl{Faites place!}@*)" > duck.txt && docker build -t user/duck:v5 .
...
\item \inline{dts}, le shell Duckietown\footnote{Il peut être obtenu à l'URL suivante: \url{https://github.com/duckietown/duckietown-shell}}

...
open class VFun<X: SFun<X>, E: `1`>(
  ...
  operator fun invoke(map: Map<SVar<X>, X> = emptyMap(), vMap: Map<VVar<X, *>, VConst<X, *>> = emptyMap()): VFun<X, E> = when (this) {
...
open class MFun<X: SFun<X>, R: `1`, C: `1`>(
  ...
  companion object {
//    @JvmName("m1x1") private operator fun <T: SFun<T>, V: VFun<T, `1`>> invoke(t0: V): MFun<T, `1`, `1`> = MFun(`1`, `1`, VFun(t0))
//    @JvmName("m1x2") private operator fun <T: SFun<T>, V: VFun<T, `2`>> invoke(t0: V): MFun<T, `1`, `2`> = MFun(`1`, `2`, VFun(t0))
//    @JvmName("m1x3") private operator fun <T: SFun<T>, V: VFun<T, `3`>> invoke(t0: V): MFun<T, `1`, `3`> = MFun(`1`, `3`, VFun(t0))
//    @JvmName("m1x4") private operator fun <T: SFun<T>, V: VFun<T, `4`>> invoke(t0: V): MFun<T, `1`, `4`> = MFun(`1`, `4`, VFun(t0))
//    @JvmName("m1x5") private operator fun <T: SFun<T>, V: VFun<T, `5`>> invoke(t0: V): MFun<T, `1`, `5`> = MFun(`1`, `5`, VFun(t0))
//    @JvmName("m1x6") private operator fun <T: SFun<T>, V: VFun<T, `6`>> invoke(t0: V): MFun<T, `1`, `6`> = MFun(`1`, `6`, VFun(t0))
//    @JvmName("m1x7") private operator fun <T: SFun<T>, V: VFun<T, `7`>> invoke(t0: V): MFun<T, `1`, `7`> = MFun(`1`, `7`, VFun(t0))
//    @JvmName("m1x8") private operator fun <T: SFun<T>, V: VFun<T, `8`>> invoke(t0: V): MFun<T, `1`, `8`> = MFun(`1`, `8`, VFun(t0))
//    @JvmName("m1x9") private operator fun <T: SFun<T>, V: VFun<T, `9`>> invoke(t0: V): MFun<T, `1`, `9`> = MFun(`1`, `9`, VFun(t0))
//    @JvmName("m2x1") private operator fun <T: SFun<T>, V: VFun<T, `1`>> invoke(t0: V, t1: V): MFun<T, `2`, `1`> = MFun(`2`, `1`, VFun(t0, t1))
//    @JvmName("m2x2") private operator fun <T: SFun<T>, V: VFun<T, `2`>> invoke(t0: V, t1: V): MFun<T, `2`, `2`> = MFun(`2`, `2`, VFun(t0, t1))
//    @JvmName("m2x3") private operator fun <T: SFun<T>, V: VFun<T, `3`>> invoke(t0: V, t1: V): MFun<T, `2`, `3`> = MFun(`2`, `3`, VFun(t0, t1))
//    @JvmName("m2x4") private operator fun <T: SFun<T>, V: VFun<T, `4`>> invoke(t0: V, t1: V): MFun<T, `2`, `4`> = MFun(`2`, `4`, VFun(t0, t1))
//    @JvmName("m2x5") private operator fun <T: SFun<T>, V: VFun<T, `5`>> invoke(t0: V, t1: V): MFun<T, `2`, `5`> = MFun(`2`, `5`, VFun(t0, t1))
//    @JvmName("m2x6") private operator fun <T: SFun<T>, V: VFun<T, `6`>> invoke(t0: V, t1: V): MFun<T, `2`, `6`> = MFun(`2`, `6`, VFun(t0, t1))
//    @JvmName("m2x7") private operator fun <T: SFun<T>, V: VFun<T, `7`>> invoke(t0: V, t1: V): MFun<T, `2`, `7`> = MFun(`2`, `7`, VFun(t0, t1))
//    @JvmName("m2x8") private operator fun <T: SFun<T>, V: VFun<T, `8`>> invoke(t0: V, t1: V): MFun<T, `2`, `8`> = MFun(`2`, `8`, VFun(t0, t1))
//    @JvmName("m2x9") private operator fun <T: SFun<T>, V: VFun<T, `9`>> invoke(t0: V, t1: V): MFun<T, `2`, `9`> = MFun(`2`, `9`, VFun(t0, t1))
//    @JvmName("m3x1") private operator fun <T: SFun<T>, V: VFun<T, `1`>> invoke(t0: V, t1: V, t2: V): MFun<T, `3`, `1`> = MFun(`3`, `1`, VFun(t0, t1, t2))
//    @JvmName("m3x2") private operator fun <T: SFun<T>, V: VFun<T, `2`>> invoke(t0: V, t1: V, t2: V): MFun<T, `3`, `2`> = MFun(`3`, `2`, VFun(t0, t1, t2))
//    @JvmName("m3x3") private operator fun <T: SFun<T>, V: VFun<T, `3`>> invoke(t0: V, t1: V, t2: V): MFun<T, `3`, `3`> = MFun(`3`, `3`, VFun(t0, t1, t2))
//    @JvmName("m3x4") private operator fun <T: SFun<T>, V: VFun<T, `4`>> invoke(t0: V, t1: V, t2: V): MFun<T, `3`, `4`> = MFun(`3`, `4`, VFun(t0, t1, t2))
//    @JvmName("m3x5") private operator fun <T: SFun<T>, V: VFun<T, `5`>> invoke(t0: V, t1: V, t2: V): MFun<T, `3`, `5`> = MFun(`3`, `5`, VFun(t0, t1, t2))
//    @JvmName("m3x6") private operator fun <T: SFun<T>, V: VFun<T, `6`>> invoke(t0: V, t1: V, t2: V): MFun<T, `3`, `6`> = MFun(`3`, `6`, VFun(t0, t1, t2))
//    @JvmName("m3x7") private operator fun <T: SFun<T>, V: VFun<T, `7`>> invoke(t0: V, t1: V, t2: V): MFun<T, `3`, `7`> = MFun(`3`, `7`, VFun(t0, t1, t2))
//    @JvmName("m3x8") private operator fun <T: SFun<T>, V: VFun<T, `8`>> invoke(t0: V, t1: V, t2: V): MFun<T, `3`, `8`> = MFun(`3`, `8`, VFun(t0, t1, t2))
//    @JvmName("m3x9") private operator fun <T: SFun<T>, V: VFun<T, `9`>> invoke(t0: V, t1: V, t2: V): MFun<T, `3`, `9`> = MFun(`3`, `9`, VFun(t0, t1, t2))
//    @JvmName("m4x1") private operator fun <T: SFun<T>, V: VFun<T, `1`>> invoke(t0: V, t1: V, t2: V, t3: V): MFun<T, `4`, `1`> = MFun(`4`, `1`, VFun(t0, t1, t2, t3))
//    @JvmName("m4x2") private operator fun <T: SFun<T>, V: VFun<T, `2`>> invoke(t0: V, t1: V, t2: V, t3: V): MFun<T, `4`, `2`> = MFun(`4`, `2`, VFun(t0, t1, t2, t3))
//    @JvmName("m4x3") private operator fun <T: SFun<T>, V: VFun<T, `3`>> invoke(t0: V, t1: V, t2: V, t3: V): MFun<T, `4`, `3`> = MFun(`4`, `3`, VFun(t0, t1, t2, t3))
//    @JvmName("m4x4") private operator fun <T: SFun<T>, V: VFun<T, `4`>> invoke(t0: V, t1: V, t2: V, t3: V): MFun<T, `4`, `4`> = MFun(`4`, `4`, VFun(t0, t1, t2, t3))
//    @JvmName("m4x5") private operator fun <T: SFun<T>, V: VFun<T, `5`>> invoke(t0: V, t1: V, t2: V, t3: V): MFun<T, `4`, `5`> = MFun(`4`, `5`, VFun(t0, t1, t2, t3))
//    @JvmName("m4x6") private operator fun <T: SFun<T>, V: VFun<T, `6`>> invoke(t0: V, t1: V, t2: V, t3: V): MFun<T, `4`, `6`> = MFun(`4`, `6`, VFun(t0, t1, t2, t3))
//    @JvmName("m4x7") private operator fun <T: SFun<T>, V: VFun<T, `7`>> invoke(t0: V, t1: V, t2: V, t3: V): MFun<T, `4`, `7`> = MFun(`4`, `7`, VFun(t0, t1, t2, t3))
//    @JvmName("m4x8") private operator fun <T: SFun<T>, V: VFun<T, `8`>> invoke(t0: V, t1: V, t2: V, t3: V): MFun<T, `4`, `8`> = MFun(`4`, `8`, VFun(t0, t1, t2, t3))
//    @JvmName("m4x9") private operator fun <T: SFun<T>, V: VFun<T, `9`>> invoke(t0: V, t1: V, t2: V, t3: V): MFun<T, `4`, `9`> = MFun(`4`, `9`, VFun(t0, t1, t2, t3))
//    @JvmName("m5x1") private operator fun <T: SFun<T>, V: VFun<T, `1`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V): MFun<T, `5`, `1`> = MFun(`5`, `1`, VFun(t0, t1, t2, t3, t4))
//    @JvmName("m5x2") private operator fun <T: SFun<T>, V: VFun<T, `2`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V): MFun<T, `5`, `2`> = MFun(`5`, `2`, VFun(t0, t1, t2, t3, t4))
//    @JvmName("m5x3") private operator fun <T: SFun<T>, V: VFun<T, `3`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V): MFun<T, `5`, `3`> = MFun(`5`, `3`, VFun(t0, t1, t2, t3, t4))
//    @JvmName("m5x4") private operator fun <T: SFun<T>, V: VFun<T, `4`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V): MFun<T, `5`, `4`> = MFun(`5`, `4`, VFun(t0, t1, t2, t3, t4))
//    @JvmName("m5x5") private operator fun <T: SFun<T>, V: VFun<T, `5`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V): MFun<T, `5`, `5`> = MFun(`5`, `5`, VFun(t0, t1, t2, t3, t4))
//    @JvmName("m5x6") private operator fun <T: SFun<T>, V: VFun<T, `6`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V): MFun<T, `5`, `6`> = MFun(`5`, `6`, VFun(t0, t1, t2, t3, t4))
//    @JvmName("m5x7") private operator fun <T: SFun<T>, V: VFun<T, `7`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V): MFun<T, `5`, `7`> = MFun(`5`, `7`, VFun(t0, t1, t2, t3, t4))
//    @JvmName("m5x8") private operator fun <T: SFun<T>, V: VFun<T, `8`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V): MFun<T, `5`, `8`> = MFun(`5`, `8`, VFun(t0, t1, t2, t3, t4))
//    @JvmName("m5x9") private operator fun <T: SFun<T>, V: VFun<T, `9`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V): MFun<T, `5`, `9`> = MFun(`5`, `9`, VFun(t0, t1, t2, t3, t4))
//    @JvmName("m6x1") private operator fun <T: SFun<T>, V: VFun<T, `1`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V): MFun<T, `6`, `1`> = MFun(`6`, `1`, VFun(t0, t1, t2, t3, t4, t5))
//    @JvmName("m6x2") private operator fun <T: SFun<T>, V: VFun<T, `2`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V): MFun<T, `6`, `2`> = MFun(`6`, `2`, VFun(t0, t1, t2, t3, t4, t5))
//    @JvmName("m6x3") private operator fun <T: SFun<T>, V: VFun<T, `3`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V): MFun<T, `6`, `3`> = MFun(`6`, `3`, VFun(t0, t1, t2, t3, t4, t5))
//    @JvmName("m6x4") private operator fun <T: SFun<T>, V: VFun<T, `4`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V): MFun<T, `6`, `4`> = MFun(`6`, `4`, VFun(t0, t1, t2, t3, t4, t5))
//    @JvmName("m6x5") private operator fun <T: SFun<T>, V: VFun<T, `5`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V): MFun<T, `6`, `5`> = MFun(`6`, `5`, VFun(t0, t1, t2, t3, t4, t5))
//    @JvmName("m6x6") private operator fun <T: SFun<T>, V: VFun<T, `6`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V): MFun<T, `6`, `6`> = MFun(`6`, `6`, VFun(t0, t1, t2, t3, t4, t5))
//    @JvmName("m6x7") private operator fun <T: SFun<T>, V: VFun<T, `7`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V): MFun<T, `6`, `7`> = MFun(`6`, `7`, VFun(t0, t1, t2, t3, t4, t5))
//    @JvmName("m6x8") private operator fun <T: SFun<T>, V: VFun<T, `8`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V): MFun<T, `6`, `8`> = MFun(`6`, `8`, VFun(t0, t1, t2, t3, t4, t5))
//    @JvmName("m6x9") private operator fun <T: SFun<T>, V: VFun<T, `9`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V): MFun<T, `6`, `9`> = MFun(`6`, `9`, VFun(t0, t1, t2, t3, t4, t5))
//    @JvmName("m7x1") private operator fun <T: SFun<T>, V: VFun<T, `1`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V, t6: V): MFun<T, `7`, `1`> = MFun(`7`, `1`, VFun(t0, t1, t2, t3, t4, t5, t6))
//    @JvmName("m7x2") private operator fun <T: SFun<T>, V: VFun<T, `2`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V, t6: V): MFun<T, `7`, `2`> = MFun(`7`, `2`, VFun(t0, t1, t2, t3, t4, t5, t6))
//    @JvmName("m7x3") private operator fun <T: SFun<T>, V: VFun<T, `3`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V, t6: V): MFun<T, `7`, `3`> = MFun(`7`, `3`, VFun(t0, t1, t2, t3, t4, t5, t6))
//    @JvmName("m7x4") private operator fun <T: SFun<T>, V: VFun<T, `4`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V, t6: V): MFun<T, `7`, `4`> = MFun(`7`, `4`, VFun(t0, t1, t2, t3, t4, t5, t6))
//    @JvmName("m7x5") private operator fun <T: SFun<T>, V: VFun<T, `5`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V, t6: V): MFun<T, `7`, `5`> = MFun(`7`, `5`, VFun(t0, t1, t2, t3, t4, t5, t6))
//    @JvmName("m7x6") private operator fun <T: SFun<T>, V: VFun<T, `6`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V, t6: V): MFun<T, `7`, `6`> = MFun(`7`, `6`, VFun(t0, t1, t2, t3, t4, t5, t6))
//    @JvmName("m7x7") private operator fun <T: SFun<T>, V: VFun<T, `7`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V, t6: V): MFun<T, `7`, `7`> = MFun(`7`, `7`, VFun(t0, t1, t2, t3, t4, t5, t6))
//    @JvmName("m7x8") private operator fun <T: SFun<T>, V: VFun<T, `8`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V, t6: V): MFun<T, `7`, `8`> = MFun(`7`, `8`, VFun(t0, t1, t2, t3, t4, t5, t6))
//    @JvmName("m7x9") private operator fun <T: SFun<T>, V: VFun<T, `9`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V, t6: V): MFun<T, `7`, `9`> = MFun(`7`, `9`, VFun(t0, t1, t2, t3, t4, t5, t6))
//    @JvmName("m8x1") private operator fun <T: SFun<T>, V: VFun<T, `1`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V, t6: V, t7: V): MFun<T, `8`, `1`> = MFun(`8`, `1`, VFun(t0, t1, t2, t3, t4, t5, t6, t7))
//    @JvmName("m8x2") private operator fun <T: SFun<T>, V: VFun<T, `2`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V, t6: V, t7: V): MFun<T, `8`, `2`> = MFun(`8`, `2`, VFun(t0, t1, t2, t3, t4, t5, t6, t7))
//    @JvmName("m8x3") private operator fun <T: SFun<T>, V: VFun<T, `3`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V, t6: V, t7: V): MFun<T, `8`, `3`> = MFun(`8`, `3`, VFun(t0, t1, t2, t3, t4, t5, t6, t7))
//    @JvmName("m8x4") private operator fun <T: SFun<T>, V: VFun<T, `4`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V, t6: V, t7: V): MFun<T, `8`, `4`> = MFun(`8`, `4`, VFun(t0, t1, t2, t3, t4, t5, t6, t7))
//    @JvmName("m8x5") private operator fun <T: SFun<T>, V: VFun<T, `5`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V, t6: V, t7: V): MFun<T, `8`, `5`> = MFun(`8`, `5`, VFun(t0, t1, t2, t3, t4, t5, t6, t7))
//    @JvmName("m8x6") private operator fun <T: SFun<T>, V: VFun<T, `6`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V, t6: V, t7: V): MFun<T, `8`, `6`> = MFun(`8`, `6`, VFun(t0, t1, t2, t3, t4, t5, t6, t7))
//    @JvmName("m8x7") private operator fun <T: SFun<T>, V: VFun<T, `7`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V, t6: V, t7: V): MFun<T, `8`, `7`> = MFun(`8`, `7`, VFun(t0, t1, t2, t3, t4, t5, t6, t7))
//    @JvmName("m8x8") private operator fun <T: SFun<T>, V: VFun<T, `8`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V, t6: V, t7: V): MFun<T, `8`, `8`> = MFun(`8`, `8`, VFun(t0, t1, t2, t3, t4, t5, t6, t7))
//    @JvmName("m8x9") private operator fun <T: SFun<T>, V: VFun<T, `9`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V, t6: V, t7: V): MFun<T, `8`, `9`> = MFun(`8`, `9`, VFun(t0, t1, t2, t3, t4, t5, t6, t7))
//    @JvmName("m9x1") private operator fun <T: SFun<T>, V: VFun<T, `1`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V, t6: V, t7: V, t8: V): MFun<T, `9`, `1`> = MFun(`9`, `1`, VFun(t0, t1, t2, t3, t4, t5, t6, t7, t8))
//    @JvmName("m9x2") private operator fun <T: SFun<T>, V: VFun<T, `2`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V, t6: V, t7: V, t8: V): MFun<T, `9`, `2`> = MFun(`9`, `2`, VFun(t0, t1, t2, t3, t4, t5, t6, t7, t8))
//    @JvmName("m9x3") private operator fun <T: SFun<T>, V: VFun<T, `3`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V, t6: V, t7: V, t8: V): MFun<T, `9`, `3`> = MFun(`9`, `3`, VFun(t0, t1, t2, t3, t4, t5, t6, t7, t8))
//    @JvmName("m9x4") private operator fun <T: SFun<T>, V: VFun<T, `4`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V, t6: V, t7: V, t8: V): MFun<T, `9`, `4`> = MFun(`9`, `4`, VFun(t0, t1, t2, t3, t4, t5, t6, t7, t8))
//    @JvmName("m9x5") private operator fun <T: SFun<T>, V: VFun<T, `5`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V, t6: V, t7: V, t8: V): MFun<T, `9`, `5`> = MFun(`9`, `5`, VFun(t0, t1, t2, t3, t4, t5, t6, t7, t8))
//    @JvmName("m9x6") private operator fun <T: SFun<T>, V: VFun<T, `6`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V, t6: V, t7: V, t8: V): MFun<T, `9`, `6`> = MFun(`9`, `6`, VFun(t0, t1, t2, t3, t4, t5, t6, t7, t8))
//    @JvmName("m9x7") private operator fun <T: SFun<T>, V: VFun<T, `7`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V, t6: V, t7: V, t8: V): MFun<T, `9`, `7`> = MFun(`9`, `7`, VFun(t0, t1, t2, t3, t4, t5, t6, t7, t8))
//    @JvmName("m9x8") private operator fun <T: SFun<T>, V: VFun<T, `8`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V, t6: V, t7: V, t8: V): MFun<T, `9`, `8`> = MFun(`9`, `8`, VFun(t0, t1, t2, t3, t4, t5, t6, t7, t8))
//    @JvmName("m9x9") private operator fun <T: SFun<T>, V: VFun<T, `9`>> invoke(t0: V, t1: V, t2: V, t3: V, t4: V, t5: V, t6: V, t7: V, t8: V): MFun<T, `9`, `9`> = MFun(`9`, `9`, VFun(t0, t1, t2, t3, t4, t5, t6, t7, t8))
//

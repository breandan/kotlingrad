...
\begin{figure}
\centering
\includegraphics[width=0.70\textwidth]{pbt_comparison.png}
\caption{Log errors between automatic differentiation and symbolic differentiation evaluated on a swollen expression. AD and SD produce roughly similar values, and both accumulate a significant error compared to infinite precision.\vspace{-10pt}}

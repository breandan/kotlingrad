...
@JvmName("times:___") operator fun <V0: XO, V1: XO, V2: XO> Ex<V0, V1, V2>.times(e: Ex<OO, OO, OO>) = Ex<V0, V1, V2>(this, e, op = Ops.`*`)
@JvmName("times:__t") operator fun <V0: XO, V1: XO, V2: XO> Ex<V0, V1, V2>.times(e: Ex<OO, OO, XX>) = Ex<V0, V1, XX>(this, e, op = Ops.`*`)
@JvmName("times:_t_") operator fun <V0: XO, V1: XO, V2: XO> Ex<V0, V1, V2>.times(e: Ex<OO, XX, OO>) = Ex<V0, XX, V2>(this, e, op = Ops.`*`)
@JvmName("times:_tt") operator fun <V0: XO, V1: XO, V2: XO> Ex<V0, V1, V2>.times(e: Ex<OO, XX, XX>) = Ex<V0, XX, XX>(this, e, op = Ops.`*`)
@JvmName("times:t__") operator fun <V0: XO, V1: XO, V2: XO> Ex<V0, V1, V2>.times(e: Ex<XX, OO, OO>) = Ex<XX, V1, V2>(this, e, op = Ops.`*`)
@JvmName("times:t_t") operator fun <V0: XO, V1: XO, V2: XO> Ex<V0, V1, V2>.times(e: Ex<XX, OO, XX>) = Ex<XX, V1, XX>(this, e, op = Ops.`*`)
@JvmName("times:tt_") operator fun <V0: XO, V1: XO, V2: XO> Ex<V0, V1, V2>.times(e: Ex<XX, XX, OO>) = Ex<XX, XX, V2>(this, e, op = Ops.`*`)
@JvmName("times:ttt") operator fun <V0: XO, V1: XO, V2: XO> Ex<V0, V1, V2>.times(e: Ex<XX, XX, XX>) = Ex<XX, XX, XX>(this, e, op = Ops.`*`)
operator fun <N: Number, V0: XO, V1: XO, V2: XO> N.times(e:Ex<V0, V1, V2>) = Ex<V0, V1, V2>(Nt(this), e, op = Ops.`*`)
operator fun <N: Number, V0: XO, V1: XO, V2: XO> Ex<V0, V1, V2>.times(n: N) = Ex<V0, V1, V2>(this, Nt(n), op = Ops.`*`)

@JvmName("div:___") operator fun <V0: XO, V1: XO, V2: XO> Ex<V0, V1, V2>.div(e: Ex<OO, OO, OO>) = Ex<V0, V1, V2>(this, e, op = Ops.`÷`)
@JvmName("div:__t") operator fun <V0: XO, V1: XO, V2: XO> Ex<V0, V1, V2>.div(e: Ex<OO, OO, XX>) = Ex<V0, V1, XX>(this, e, op = Ops.`÷`)
@JvmName("div:_t_") operator fun <V0: XO, V1: XO, V2: XO> Ex<V0, V1, V2>.div(e: Ex<OO, XX, OO>) = Ex<V0, XX, V2>(this, e, op = Ops.`÷`)
@JvmName("div:_tt") operator fun <V0: XO, V1: XO, V2: XO> Ex<V0, V1, V2>.div(e: Ex<OO, XX, XX>) = Ex<V0, XX, XX>(this, e, op = Ops.`÷`)
@JvmName("div:t__") operator fun <V0: XO, V1: XO, V2: XO> Ex<V0, V1, V2>.div(e: Ex<XX, OO, OO>) = Ex<XX, V1, V2>(this, e, op = Ops.`÷`)
@JvmName("div:t_t") operator fun <V0: XO, V1: XO, V2: XO> Ex<V0, V1, V2>.div(e: Ex<XX, OO, XX>) = Ex<XX, V1, XX>(this, e, op = Ops.`÷`)
@JvmName("div:tt_") operator fun <V0: XO, V1: XO, V2: XO> Ex<V0, V1, V2>.div(e: Ex<XX, XX, OO>) = Ex<XX, XX, V2>(this, e, op = Ops.`÷`)
@JvmName("div:ttt") operator fun <V0: XO, V1: XO, V2: XO> Ex<V0, V1, V2>.div(e: Ex<XX, XX, XX>) = Ex<XX, XX, XX>(this, e, op = Ops.`÷`)
operator fun <N: Number, V0: XO, V1: XO, V2: XO> N.div(e:Ex<V0, V1, V2>) = Ex<V0, V1, V2>(Nt(this), e, op = Ops.`÷`)
operator fun <N: Number, V0: XO, V1: XO, V2: XO> Ex<V0, V1, V2>.div(n: N) = Ex<V0, V1, V2>(this, Nt(n), op = Ops.`÷`)

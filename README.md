...
|   <sup>da</sup>&frasl;<sub>db</sub><br>a'(b)    |          `a.d(b)`             |           `grad(a)[b]`           |            `d(a) / d(b)`            |                     (`a`: C(ℝ<sup>m</sup>)<sup>*</sup>, `b`: ℝ→ℝ) → (ℝ<sup>?</sup>→ℝ)                      |
|                       ∇a                        |                               |            `grad(a)`             |             `a.grad()`              |                    (`a`: C(ℝ<sup>?</sup>)<sup>*</sup>) → (ℝ<sup>?</sup>→ℝ<sup>?</sup>)                     |

...
Property-based testing (PBT) is a specific type of fuzz testing which addresses the test oracle problem by using properties. PBT has two phases, seaching and shrinking. Users specify a property and It can be seen as follows:
%
\begin{kotlinlisting}

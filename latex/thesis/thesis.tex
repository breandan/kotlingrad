...
Another type of adversary is a generative adversary~\citep{goodfellow2014gan, albuquerque2019hgan}. Consider the qualities of a good adversary. Not only must she be able to exploit weaknesses of the model, but also possess some understanding of the underlying data distribution.

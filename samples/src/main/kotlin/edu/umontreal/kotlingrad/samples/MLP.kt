...
fun main() = with(DoublePrecision) {
  var w1: VFun<DReal, D3> = Vec(D3) { 1.0 }
  var w2: MFun<DReal, D3, D3> = Mat(D3, D3) { 1.0 }
  var w3: VFun<DReal, D3> = Vec(D3) { 1.0 }

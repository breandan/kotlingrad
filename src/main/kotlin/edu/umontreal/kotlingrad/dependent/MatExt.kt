...
fun <T, R: `9`, C: `9`, M: Mat<T, R, C>> M.transpose() =
...
@JvmName("longMatMinus") infix operator fun <R: `9`, C: `9`, M: Mat<Long, R, C>> M.minus(v: M): Mat<Long, R, C> = Mat<Long, R, C>(rowT, colT, contents.zip(v.contents).map { it.first - it.second })
@JvmName("intMatMinus") infix operator fun <R: `9`, C: `9`, M: Mat<Int, R, C>> M.minus(v: M): Mat<Int, R, C> = Mat<Int, R, C>(rowT, colT, contents.zip(v.contents).map { it.first - it.second })
@JvmName("shortMatMinus") infix operator fun <R: `9`, C: `9`, M: Mat<Short, R, C>> M.minus(v: M): Mat<Short, R, C> = Mat<Short, R, C>(rowT, colT, contents.zip(v.contents).map { it.first - it.second })
@JvmName("byteMatMinus") infix operator fun <R: `9`, C: `9`, M: Mat<Byte, R, C>> M.minus(v: M): Mat<Byte, R, C> = Mat<Byte, R, C>(rowT, colT, contents.zip(v.contents).map { it.first - it.second })
@JvmName("doubleMatMinus") infix operator fun <R: `9`, C: `9`, M: Mat<Double, R, C>> M.minus(v: M): Mat<Double, R, C> = Mat<Double, R, C>(rowT, colT, contents.zip(v.contents).map { it.first - it.second })
@JvmName("floatMatMinus") infix operator fun <R: `9`, C: `9`, M: Mat<Float, R, C>> M.minus(v: M): Mat<Float, R, C> = Mat<Float, R, C>(rowT, colT, contents.zip(v.contents).map { it.first - it.second })

@JvmName("longMatMult") infix operator fun <R1: `9`, C1: `9`, C2: `9`> Mat<Long, R1, C1>.times(v: Mat<Long, C1, C2>): Mat<Long, R1, C2> {
...
@JvmName("shortMatMult") infix operator fun <R1: `9`, C1: `9`, C2: `9`> Mat<Short, R1, C1>.times(v: Mat<Short, C1, C2>): Mat<Short, R1, C2> {
...
@JvmName("byteMatMult") infix operator fun <R1: `9`, C1: `9`, C2: `9`> Mat<Byte, R1, C1>.times(v: Mat<Byte, C1, C2>): Mat<Byte, R1, C2> {
...
@JvmName("floatMatMult") infix operator fun <R1: `9`, C1: `9`, C2: `9`> Mat<Float, R1, C1>.times(v: Mat<Float, C1, C2>): Mat<Float, R1, C2> {

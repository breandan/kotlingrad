...
\path[draw=none] (interior.north west) rectangle node[white]{\includegraphics[width=9mm]{../figures/kotlin_file.png}} ([xshift=-15mm,yshift=-15mm]interior.north west);
}
}
...
underlay unbroken and first={%
\path[draw=none] (interior.north west) rectangle node[white]{\includegraphics[width=9mm]{../figures/python_icon.png}} ([xshift=-15mm,yshift=-15mm]interior.north west);
}
}

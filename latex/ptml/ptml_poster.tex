...
We can detect the presence and location of the error within the editor.
      ...
      \begin{tabular}{|c|c|c|c|l|}
        ...
        $\mathbf{\mathbf{A}}(\mathbf{\mathbf{B}})$,$\mathbf{\mathbf{A}}\circ\mathbf{\mathbf{B}}$  & \tinline{a(b)} & & & $($\tinline{a}$:  \mathbb{R}^{\tau}\rightarrow\mathbb{R}^{\pi}$, \tinline{b}$: \mathbb{R}^{\lambda} \rightarrow \mathbb{R}^{\tau}) \rightarrow (\mathbb{R}^{\lambda}\rightarrow \mathbb{R}^{\pi})$ \\ \hline
        $\mathbf{\mathbf{A}}\pm\mathbf{\mathbf{B}}$ & \tinline{a + b}, \tinline{a - b} & \tinline{plus(a, b)} &  & $($\tinline{a}$: \mathbb{R}^{\tau}\rightarrow\mathbb{R}^{\pi},~$\tinline{b}$: \mathbb{R}^{\lambda} \rightarrow \mathbb{R}^{\pi}) \rightarrow (\mathbb{R}^{?}\rightarrow \mathbb{R}^{\pi})$ \\ \hline
        $\mathbf{A}  \mathbf{B}$ & \tinline{a * b}, \tinline{a.times(b)}    & \tinline{times(a, b)} & & $($\tinline{a}$: \mathbb{R}^{\tau}\rightarrow\mathbb{R}^{m \times n},~$\tinline{b}$: \mathbb{R}^{\lambda}\rightarrow\mathbb{R}^{n \times p})  \rightarrow (\mathbb{R}^{?}\rightarrow\mathbb{R}^{m \times p})$ \\ \hline
...
\null\hspace*{2cm}\begin{minipage}[c]{0.40\columnwidth}
                    ...
                    \center\resizebox{0.95\linewidth}{!}{%
                    \includegraphics{../figures/plot.png}
                    }
\end{minipage}

\null\hspace*{2cm}\begin{minipage}[c]{0.50\columnwidth}
\begin{kotlinlisting}
...
\end{kotlinlisting}
\end{minipage}
      \null\hspace*{2cm}\begin{minipage}[c]{0.30\columnwidth}
    \center\resizebox{0.95\linewidth}{!}{%
...
\null\hspace*{2cm}\begin{minipage}[c]{0.5\columnwidth}
\begin{tikzpicture}
\begin{axis}[title={Log errors evaluating $f(x) = \frac{\sin(\sin(\sin(x))))}{x} + x\sin(x) + \cos(x) + x$}, height=20cm, width=35cm, xlabel=$x$, ylabel=$\log_{10}(\Delta)$, xtick={-1000,-750,...,1000}, legend pos=south east, align=center, compat=newest]
...
\end{minipage}
      ...
      \null\hspace*{2cm}\begin{minipage}[c]{0.90\columnwidth}
                            \center\resizebox{0.95\linewidth}{!}{%
                            \includegraphics{../figures/diff_prob_prog.png}
                            }
      \end{minipage}

      \jointspacing

      \mysection{Double Pendulum}
      ...
      \null\hspace*{2cm}\begin{minipage}[c]{0.80\columnwidth}
                            \center\resizebox{0.85\linewidth}{!}{%
                            \includegraphics{../figures/double_pendulum.png}
                            }
      \end{minipage}

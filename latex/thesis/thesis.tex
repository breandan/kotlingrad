...
\langle type\rangle & ::= \text{\inline{Double}} \mid \text{\inline{Int}} \mid \text{\inline{Float}} \mid \text{\inline{BigInteger}} \mid \text{\inline{BigDouble}}

\langle typeInt\rangle & ::= \text{\inline{`1`}} \mid ... \mid \text{\inline{`99`}}

\langle var\rangle & ::= \text{\inline{x}} \mid \text{\inline{y}} \mid \text{\inline{z}} \mid \text{\inline{ONE}} \mid \text{\inline{ZERO}} \mid \text{\inline{E}}

\langle binaryOp\rangle & ::= \text{\inline{+}} \mid \text{\inline{-}} \mid \text{\inline{*}} \mid \text{\inline{/}} \mid \text{\inline{pow}} \mid \text{\inline{log}}

\langle unaryOp\rangle & ::= \text{\inline{sin}} \mid \text{\inline{cos}} \mid \text{\inline{tan}} \mid \text{\inline{-}}

\langle expr\rangle & ::= \langle var\rangle \mid \langle unaryOp\rangle\langle expr\rangle \mid \langle var\rangle\langle binaryOp\rangle\langle expr\rangle \mid \langle deriv\rangle

\langle deriv\rangle & ::= \text{\inline{d(}}\langle expr\rangle \text{\inline{)}} \text{\inline{/d(}} \langle expr\rangle \text{\inline{)}} \mid \langle expr\rangle\text{\inline{.diff(}} \langle expr\rangle \text{\inline{)}}

\langle bindings\rangle & ::= \langle expr\rangle\text{\inline{ to }}\langle expr\rangle \mid \langle expr\rangle\text{\inline{ to }}\langle expr\rangle\text{\inline{,}}\langle bindings\rangle

\langle invoke\rangle & ::= \langle expr\rangle \text{\inline{(}} \langle bindings\rangle \text{\inline{)}}

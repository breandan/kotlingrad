...
open class VectorFun<X: Field<X>, MaxLength: `100`> protected constructor(
...
class VectorNeg<X: Field<X>, MaxLength: `100`> internal constructor(
...
class VectorDotProduct<X: Field<X>, MaxLength: `100`> internal constructor(
  val multiplicator: VectorFun<X, MaxLength>,
  val multiplicand: VectorFun<X, MaxLength>
): VectorFun<X, MaxLength>(multiplicator.length, multiplicator.variables + multiplicand.variables)
...
class VectorConst<X: Field<X>, MaxLength: `100`> internal constructor(

...
\bnfrl{typeInt} & ::= & \code{`1`} \mor \ldots \mor \code{`99`} \\
\bnfrl{var} & ::= & \code{x} \mor \code{y} \mor \code{z} \mor \code{ONE} \mor \code{ZERO} \mor \code{E} \\
\bnfrl{addOp} & ::= & \code{+} \mor \code{-} \\
\bnfrl{binaryOp} & ::= & \bnfrl{addOp} \mor \code{*} \mor \code{/} \mor \code{pow} \\
\bnfrl{unaryOp} & ::= & \bnfrl{addOp} \mor \code{sin} \mor \code{cos} \mor \code{tan} \mor \code{sqrt} \mor \code{log} \mor \code{ln} \mor \code{exp} \\
\bnfrl{expr} & ::= & \bnfrl{var} \mor \bnfrl{unaryOp}\bnfrl{expr} \mor \bnfrl{var}\bnfrl{binaryOp}\bnfrl{expr} \mor \code{(} \bnfrl{expr} \code{)} \\
\bnfrl{exprList} & ::= & \bnfrl{expr} \mor \bnfrl{expr} \code{,} \bnfrl{exprList} \\
\bnfrl{linearOp} & ::= & \bnfrl{addOp} \mor \code{*} \mor \code{ dot } \\
\bnfrl{vec} & ::= & \code{Vec(} \bnfrl{exprList} \code{)} \mor \code{Vec(} \bnfrl{typeInt} \code{)(} \bnfrl{exprList} \code{)} \\
\bnfrl{vecExpr} & ::= & \bnfrl{vec} \mor \bnfrl{addOp}\bnfrl{vecExpr} \mor \bnfrl{expr} \code{*} \bnfrl{vecExpr} \mor \bnfrl{vec} \bnfrl{linearOp} \bnfrl{vecExpr} \\
\bnfrl{mat} & ::= & \code{Mat(} \bnfrl{typeInt} \code{,} \bnfrl{typeInt} \code{)(} \bnfrl{exprList} \code{)} \\
\bnfrl{matExpr} & ::= & \bnfrl{mat} \mor \bnfrl{addOp}\bnfrl{matExpr} \mor \bnfrl{expr}\bnfrl{linearOp}\bnfrl{matExpr} \mor \\
&&\bnfrl{vecExpr}\bnfrl{linearOp}\bnfrl{matExpr} \mor \bnfrl{mat} \bnfrl{linearOp} \bnfrl{matExpr} \\
\bnfrl{anyExpr} & ::= & \bnfrl{expr} \mor \bnfrl{vecExpr} \mor \bnfrl{matExpr} \\
\bnfrl{bindings} & ::= & \bnfrl{expr} \code{ to } \bnfrl{expr} \mor \bnfrl{expr} \code{ to } \bnfrl{expr} \code{,} \bnfrl{bindings} \\
\bnfrl{invoke} & ::= & \bnfrl{anyExpr} \code{(} \bnfrl{bindings} \code{)} \\
\bnfrl{deriv} & ::= & \code{d(} \bnfrl{anyExpr} \code{) / d(} \bnfrl{expr} \code{)} \mor \bnfrl{anyExpr} \code{.diff(} \bnfrl{expr} \code{)}
\end{eqnarray*}

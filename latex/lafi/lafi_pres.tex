...
% \title[Short title]{Kotlin\nabla}
% \subtitle{Differentiable}
% % Differentiable functional programming with algebraic data types
% % The short title appears at the bottom of every slide, the full title is only on the title page

% \author{Breandan Considine} % Your name
% \institute[Universit\'e de Montr\'eal] % Your institution as it will appear on the bottom of every slide, may be shorthand to save space
% {
% Universit\'e de Montr\'eal \\ % Your institution for the title page
% \medskip
% \textit{breandan.considine@umontreal.ca} % Your email address
% }

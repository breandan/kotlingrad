...
\end{axis}
\end{tikzpicture}
\caption{We compare numerical drift between AD and SD over a swollen expression with Double precision. AD and SD both produce similar error and numerical drift when compared to infinite precision (IP). This result supports the findings of ~\citet{laue2019equivalence}.\vspace{-10pt}}

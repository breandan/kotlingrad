...
Hatchery is compatible with most IDEs on the IntelliJ Platform, including \href{https://developer.android.com/studio}{Android Studio}, the official IDE for Android mobile development. To use ROS specific features from within Android Studio, ensure the Hatchery plugin is installed as described in ~\autoref{sec:installation}. Create a new Android project or clone an existing one. Then create a symbolic link inside the Android project's root directory to the location of the ROS project:
...
To use Kotlin$\nabla$ from an Android project, add a custom Maven repository to the project's \inline{build.gradle.kts} file:
%
\begin{kotlinlisting}
repositories {
...
\end{kotlinlisting}
%
Kotlin$\nabla$ can now be used on Android.

...
In traditional software engineering, the Waterfall Method is a classical software process model that comprises of five stages. We propose contributions to four: design in Chap.~\ref{ch:hatchery}, implementation in Chap.~\ref{ch:kotlingrad}, testing in Chap.~\ref{ch:difftest} and maintenance in Chap.~\ref{ch:software-reproducibility}.

...
\end{axis}
\end{tikzpicture}
\caption{By construction, our differential shrinker detects a greater number of errors per input-output pair than a na\"ive sampler which ignores the gradient.}
\label{fig:pbt_comparison}
\end{figure}

...
|       **A** + **1**<br>**A** - **1**       |    `a + one`<br>`a - one`     |          `++a`<br>`--a`          | `a++`,`a.inc()`<br>`a--`,`a.dec()`  |              (ℝ<sup>#</sup>→ℝ<sup>M<sup>N</sup></sup>) → (ℝ<sup>#</sup>→ℝ<sup>M<sup>N</sup></sup>)               |
...
|                  √a<br>∛a                  | `a.pow(1.0/2)`<br>`a.root(3)` |      `sqrt(a)`<br>`cbrt(a)`      |      `a.sqrt()`<br>`a.cbrt()`       |                                                  (ℝ→ℝ) → (ℝ→ℝ)                                                   |

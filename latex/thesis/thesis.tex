...
\end{bnflisting}
%
%Or, alternately, in railroad form:
%%
%\begin{rail}
...
\begin{todolist}
    ...
    \item[\done] \href{http://wiki.ros.org/msg}{ROS Message (\href{http://wiki.ros.org/msg}{\inline{*.msg}})}
    \item[\done] Syntax highlighting
    \item[\done] \href{http://wiki.ros.org/srv}{ROS Service (\href{http://wiki.ros.org/srv}{\inline{*.srv}})}
